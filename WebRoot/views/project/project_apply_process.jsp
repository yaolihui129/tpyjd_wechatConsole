...
<body class="page-header-fixed">
    ...
    <div class="page-container row-fluid">
                                                            ...
                                                            <tbody id="list">
                                                            	<c:forEach items="${list}" var="item" varStatus="status">
	                                                                <tr class="odd gradeX">
	                                                                    ...
	                                                                    <td>
	                                                                        <a href="javascript:;" onclick="orderUpdata('${item.project_apply_process_id}', 'top');" class="btn black-stripe mini"><i class="icon-circle-arrow-up"></i> 置顶</a>
																			<a href="javascript:;" onclick="orderUpdata('${item.project_apply_process_id}', 'up');" class="btn black-stripe mini"><i class="icon-arrow-up"></i> 上移</a>
																			<a href="javascript:;" onclick="orderUpdata('${item.project_apply_process_id}', 'down');" class="btn black-stripe mini"><i class="icon-arrow-down"></i> 下移</a>
																			<a href="#myModal3" class="btn green-stripe mini updata" role="button" data-toggle="modal"><i class="icon-edit"></i> 编辑</a>
																			<a href="javascript:;" data-id="${item.project_apply_process_id}" class="btn red-stripe mini trash"><i class="icon-trash"></i> 删除</a>
	                                                                    </td>
	                                                                </tr>
                                                                </c:forEach>
                                                            </tbody>
	                                        ...
	                                        <div class="portlet-body form">
	                                            <!-- BEGIN FORM-->
	                                                <div class="row-fluid">
	                                                    <div class="span12 ">
	                                                        <div class="control-group">
	                                                            <label class="control-label span3">流程名称:</label>
	                                                            <div class="controls span9">
	                                                                <input id="name"  must-be="true" data-label="流程名称"  data-length="20"  placeholder="此办理流程名称" type="text" class="m-wrap span10" name="name"/>
	                                                ...
	                                                <div class="row-fluid">
	                                                    <div class="span12 ">
	                                                        <div class="control-group">
	                                                            <label class="control-label span3">流程周期:</label>
	                                                            <div class="controls span9">
	                                                                <input id="cycle" must-be="true" data-label="流程周期"  data-length="20" placeholder="此办理流程的办理周期，如2-3天"  type="text" class="m-wrap span10" name="cycle"/>
	                                                                <span style="color:red;margin-left:10px;">*</span>
	                                                            </div>
	                                                        </div>
	                                                    </div>
	                                                ...
	                                                <div class="row-fluid">
	                                                    <div class="span12 ">
	                                                        <div class="control-group">
	                                                            <label class="control-label span3">办理内容:</label>
	                                                            <div class="controls span9">
	                                                            	<textarea id="content" must-be="true"  data-label="办理内容"  data-length="100"  class="span10 m-wrap" rows="6" name="content"></textarea>
	                                                            	<span style="color:red;margin-left:10px;">*</span>
	                                                            </div>
	                                                        </div>
	                                                    </div>
		...
		function orderUpdata(id, order) {
			$.post("/project/applyp/priority",{"id":id, "order":order},function(data){
				if(data.status==0) {
					alert(data.msg);
					doRequest();
				} else {
