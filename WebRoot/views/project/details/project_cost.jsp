                                                            ...
                                                            <tbody id="list">
                                                            	<c:forEach items="${list}" var="item" varStatus="status">
	                                                                <tr class="odd gradeX">
	                                                                    ...
	                                                                    <%-- <td>
	                                                                        <a href="/project/cost/priority/${item.project_cost_id }?order=up">上移</a>
	                                                                        <a href="/project/cost/priority/${item.project_cost_id }?order=down">下移</a>
	                                                                        <a href="/project/cost/priority/${item.project_cost_id }?order=top">置顶</a>
	                                                                    </td>
	                                                                    <td>
	                                                                        <a class="updata" href="#myModal3" role="button" data-toggle="modal"><i class="icon-edit" style="margin-right:2px;"></i>编辑</a>
	                                                                        <a class="trash" data-id="${item.project_cost_id}" href="javascript:;" style="color:#555555;margin-left:10px;"><i class="icon-trash" style="margin-right:2px;"></i>删除</a>
	                                                                    </td> --%>
	                                                                </tr>
                                                                </c:forEach>
                                                            </tbody>
	                                        ...
	                                        <div class="portlet-body form">
	                                            BEGIN FORM
	                                                ...
	                                                <div class="row-fluid">
	                                                    <div class="span12 ">
	                                                        <div class="control-group">
	                                                            <label class="control-label">收费机构:</label>
	                                                            <div class="controls">
	                                                                <input id="institution"  type="text" class="m-wrap span10" name="institution"/>
	                                                                <span style="color:red;margin-left:10px;">*</span>
	                                                            </div>
	                                                        </div>
	                                                    </div>
	                                                ...
	                                                <div class="row-fluid">
	                                                    <div class="span12 ">
	                                                        <div class="control-group">
	                                                            ...
	                                                            <div class="controls">
	                                                                <input id="cost"  type="text" class="m-wrap span10" name="cost"/>
	                                                                <span style="color:red;margin-left:10px;">*</span>
	                                                            </div>
	                                                        </div>
	                                                    </div>
	                                                ...
	                                                <div class="row-fluid">
	                                                    <div class="span12 ">
	                                                        <div class="control-group">
	                                                            <label class="control-label">收费时间/阶段:</label>
	                                                            <div class="controls">
	                                                                <input id="charge_stage"  type="text" class="m-wrap span10" name="charge_stage"/>
	                                                            </div>
	                                                        </div>
	                                                    </div>
	                                                </div>
	                                                <div class="row-fluid">
	                                                    <div class="span12 ">
	                                                        <div class="control-group">
	                                                            <label class="control-label">退款标准:</label>
	                                                            <div class="controls">
	                                                                <input id="refund_standard" type="text" class="m-wrap span10" name="refund_standard"/>
	                                                            </div>
	                                                        </div>
	                                                    </div>
	                                                </div>
