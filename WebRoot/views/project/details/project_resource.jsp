                                                            ...
                                                            <tbody id="list">
                                                            	<c:forEach items="${list}" var="item" varStatus="status">
	                                                                <tr class="odd gradeX">
	                                                                    ...
	                                                                    <td>
																			<c:choose>
																				<c:when test="${item.media_type==00200002}">
																					${item.url}
																				</c:when>
																				<c:otherwise>
	                                                                    ...
	                                                                    <%-- <td>
	                                                                        <a href="/project/resource/priority/${item.project_resource_id }?order=up">上移</a>
	                                                                        <a href="/project/resource/priority/${item.project_resource_id }?order=down">下移</a>
	                                                                        <a href="/project/resource/priority/${item.project_resource_id }?order=top">置顶</a>
	                                                                    </td>
	                                                                    <td>
	                                                                        <a class="updata" href="#myModal3" role="button" data-toggle="modal"><i class="icon-edit" style="margin-right:2px;"></i>编辑</a>
	                                                                        <a class="trash" data-id="${item.project_resource_id}" href="javascript:;" style="color:#555555;margin-left:10px;"><i class="icon-trash" style="margin-right:2px;"></i>删除</a>
	                                                                    </td> --%>
	                                                                </tr>
                                                                </c:forEach>
                                                            </tbody>
	                                    ...
	                                    <div class="modal-body" style="max-height:600px;">
	                                        <div class="portlet-body form">
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            <label class="control-label span3">标题:</label>
                                                            <div class="controls span9">
                                                                <input id="title"  type="text" class="m-wrap span10" name="title"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="control-group">
															<label class="control-label span3">媒体类型:</label>
															<div class="controls span9">
																<label class="radio" >
                                                ...
                                                <div id="media_type_pic" class="row-fluid" style="display:none;">
	                                                <div class="span12">
	                                                    <div class="portlet-body form">
	                                                        BEGIN FORM
	                                                            <div class="control-group">
	                                                                <label class="control-label span3">图片上传:</label>
	                                                                <div class="controls span9">
                                                ...
                                                <div id="media_type_tv" class="row-fluid" style="display:none;">
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            <label class="control-label span3">视频地址:</label>
                                                            <div class="controls span9">
                                                            	<input id="url"  type="text" class="m-wrap span10" name="url"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls span9">
                                                            	<input id="description"  type="text" class="m-wrap span10" name="description"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
