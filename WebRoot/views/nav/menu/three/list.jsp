...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb clear">
							...
							<li>
								...
								<i class="icon-angle-right"></i>
							<li>
								<a href="/official/nav/menu/two/${two.menuPid}">二级菜单</a> 
				...
				<!-- END PAGE HEADER-->
				<h4 class="form-section">二级菜单：${two.menuName}</h4>
				<div class="portlet box grey">
							<div class="portlet-title">
								<div class="actions">
                                    <a href="/official/nav/menu/three/add/${two.navMenuId}" class="btn blue"><i class="icon-pencil"></i>新增</a>
                                </div>
							</div>
											...
											<c:forEach var="item" items="${list}" varStatus="status">
												<tr>
													...
													<td>
														...
														<a  href="/official/nav/menu/three/updata/${item.nav_menu_id}" class="btn green-stripe mini edit"><i class="icon-edit"></i> 编辑</a>
													</td>
												</tr>
											</c:forEach>
										</c:if>
	...
	<script>
		...
		function del(id) {
			if(confirm("确定要删除吗？")){
				$.post("/official/nav/menu/three/delete/"+id, function(data){
					if(data.status==0) {
						alert(data.msg);
		...
		function orderUpdata(id, order) {
			$.post("/official/nav/menu/three/order", {'id':id, 'order':order}, function(data){
				if(data.status==0) {
					/* alert(data.msg); */
					window.location.reload();
				} else {
