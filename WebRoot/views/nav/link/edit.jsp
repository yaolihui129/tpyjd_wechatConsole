                                ...
                                <div class="tab-pane active">
                                    <div class="portlet-body form">
                                        ...
                                        <form id="sform" class="form-horizontal"  method="post">
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span5" data-length="20" must-be="true" data-label="标题" 
                                                              placeholder="标题" name="title" value="${friendly.title}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span5" data-length="200" must-be="true" data-label="链接地址" 
                                                              placeholder="链接地址" name="url" value="${friendly.url}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!--/row-->
											<input  name="friendly_link_id" type="hidden" value="${friendly.friendlyLinkId}" />
