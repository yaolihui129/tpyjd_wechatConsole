                    ...
                    <div class="span12">
                        ...
                        <div class="tabbable tabbable-custom">
                            <ul class="nav nav-tabs">
								...
								<li class="active"><a href="javascript:;" >底部管理</a></li>
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form id="sform" class="form-horizontal"  method="post">
                                                                ...
                                                                <div class="controls">
                                                                    <div class="fileupload fileupload-new">
                                                                        <div class="fileupload-new thumbnail" style="width: 455px; height: 46px;float:left;">
                                                                            <img id="show_logo_img" src="${footers.logoImg}" alt="" />
                                                                            <input id="pdt_logo_img" name="pdt_logo_img" multiple accept="image/*" type="file" style="display: none;">
                                                                            <input must-be="true" data-label="封面图片"  type="hidden" id="logo_img" name="logo_img" value="${footers.logoImg}"/>
                                                                        </div>
                                                                        <div class="span5">
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span3" data-length="100" must-be="true" data-label="公司名称" 
                                                              placeholder="公司名称" name="company_name" value="${footers.companyName}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span3" data-length="200" must-be="true" data-label="公司地址" 
                                                              placeholder="公司地址" name="company_add" value="${footers.companyAdd}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span3" data-length="100" must-be="true" data-label="客服邮箱" 
                                                              placeholder="客服邮箱" name="email" value="${footers.email}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        <label class="control-label">全国咨询热线:</label>
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span3" data-length="50" must-be="true" data-label="全国咨询热线" 
                                                              placeholder="全国咨询热线" name="service_hotline" value="${footers.serviceHotline}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        <label class="control-label">咨询服务热线:</label>
                                                        <div class="controls">
                                                            <input type="text" class="m-wrap span3" data-length="50" must-be="true" data-label="全国咨询热线" 
                                                              placeholder="全国咨询热线" name="customer_hotline" value="${footers.customerHotline}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                	...
                                                                	<%-- <div class="row-fluid span8" style="margin-bottom:15px;">
                                                                		 ...
                                                                		 <div class="controls">
                                                                		 	<input type="text" class="m-wrap span5" data-length="20" must-be="true" data-label="图片描述" 
                                                            							  placeholder="关注公众号" name="wx_img_one_description" value="${footers.wxImgOneDescription}">
                                                                		 </div>
                                                                	</div> --%>
                                                                	
                                                                	<div class="row-fluid span8">
                                                                		 <label class="control-label">公众号1:</label>
                                                                		 <div class="controls">
	                                                                		 <div class="fileupload fileupload-new span10">
		                                                                        <div class="fileupload-new thumbnail span6" style="width: 120px; height: 120px;">
		                                                                            <img id="show_wx_img_one" src="${footers.wxImgOne}" alt="" />
		                                                                            <input id="pdt_wx_img_one" name="pdt_wx_img_one" multiple accept="image/*" type="file" style="display: none;">
		                                                                            <input  must-be="true" data-label="上传图片"  type="hidden" id="wx_img_one" name="wx_img_one" value="${footers.wxImgOne}"/>
		                                                                        </div>
			                                                                    <div class="span6">
                                                                 ...
                                                                 <%-- <div class="row-fluid span8" style="margin-bottom:15px;">
                                                               		 ...
                                                               		 <div class="controls">
                                                               		 	<input type="text" class="m-wrap span5" data-length="20" must-be="true" data-label="图片描述" 
                                                             					placeholder="关注公众号" name="wx_img_two_description" value="${footers.wxImgTwoDescription}">
                                                               		 </div>
                                                               	</div> --%>
                                                                	
                                                                 <div class="row-fluid span8">
                                                                		 <label class="control-label">公众号2:</label>
                                                                		 <div class="controls">
	                                                                		 <div class="fileupload fileupload-new span10">
		                                                                        <div class="fileupload-new thumbnail span6" style="width: 120px; height: 120px;">
		                                                                            <img id="show_wx_img_two" src="${footers.wxImgTwo}" alt="" />
		                                                                            <input id="pdt_wx_img_two" name="pdt_wx_img_two" multiple accept="image/*" type="file" style="display: none;">
		                                                                            <input  must-be="true" data-label="上传图片"  type="hidden" id="wx_img_two" name="wx_img_two" value="${footers.wxImgTwo}"/>
		                                                                        </div>
			                                                                    <div class="span6">
                                            ...
                                            <!--/row-->
											<input  name="page_footers_id" type="hidden" value="${footers.pageFootersId}" />
