						...
						<c:forEach items="${editList}" var="item">
							<li class="timeline-yellow">
								<div class="timeline-time">
									<span class="date"><fmt:formatDate value="${item.create_time }" pattern="yyyy/MM/dd"/></span>
									<span class="time"><fmt:formatDate value="${item.create_time }" pattern="HH:mm:ss"/></span></span>
								</div>
								...
								<div class="timeline-body">
									<h2>${item.user_name }:${item.remark }</h2>
								</div>
							</li>
						</c:forEach>
						</ul>
