							...
							<div class="tab-content">
								<div class="portlet-title" >
									...
									<div class="actions" align="left">
										<button class="btn blue" id="editBtn"> <i class="icon-edit"></i>编辑</button>
										...
										<button class="btn red" id="recordBtn"> <i class="icon-retweet"></i>编辑记录</button>
									</div>
								</div>
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box green">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>客户信息</div>
											<div class="tools">
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${cust.name }" id="name" name="name" class="m-wrap span6" placeholder="姓名" disabled="disabled">
														</div>
													</div>
													<!--/span-->
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${cust.nickName }" id="nick_name" name = "nick_name" class="m-wrap span6" placeholder="所属部门" disabled="disabled">
														</div>
													</div>
													<!--/span-->
												</div>
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">                                                
																<label class="radio">
																<input type="radio" id="gender" name="gender" value="m" <c:if test="${cust.gender == 'm' }"> checked</c:if> disabled="disabled"/>
																男
																</label>
																<label class="radio">
																<input type="radio" id="gender" name="gender" value="f"  <c:if test="${cust.gender == 'f' }"> checked</c:if> disabled="disabled"/>
																女
																</label>  
															</div>
														</div>
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<select class="span6 select2_category"  data-placeholder="所在地区" tabindex="1" name="cust_source" id="cust_source" disabled="disabled">
																<option value=""></option>
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<select class="span6 select2_category"  data-placeholder="线索来源" tabindex="1" name="cust_source" id="cust_source" disabled="disabled">
																<option value=""></option>
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<select class="span6 select2_category"  data-placeholder="线索状态" tabindex="1" name="cust_source" id="cust_source" disabled="disabled">
																<option value=""></option>
																<c:forEach items="${csourceList}" var="csource">
																	<c:if test="${cust.custSource ==  csource.dictCode}">
																		<option value="${csource.dictCode }" selected>${csource.name}</option>
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${cust.name }" id="name" name="name" class="m-wrap span6" placeholder="推荐人" disabled="disabled">
														</div>
													</div>
													<!--/span-->
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${cust.nickName }" id="nick_name" name = "nick_name" class="m-wrap span6" placeholder="负责人" disabled="disabled">
														</div>
													</div>
													<!--/span-->
												</div>   
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${cust.name }" id="name" name="name" class="m-wrap span6" placeholder="电话" disabled="disabled">
														</div>
													</div>
													<!--/span-->
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${cust.nickName }" id="nick_name" name = "nick_name" class="m-wrap span6" placeholder="常用电话" disabled="disabled">
														</div>
													</div>
													<!--/span-->
												</div>    
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${intention.intention }" id="intention" name="intention" class="m-wrap span6" placeholder="移民目的" disabled="disabled">
														</div>
													</div>
													<!--/span-->
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${intention.calculation_min }" id="calculation_min" name = "calculation_min" class="m-wrap span6" placeholder="预算资金" disabled="disabled">
														</div>
													</div>
													<!--/span-->
												</div>
												...
												<div class="row-fluid">
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<input type="text" value="${intention.family_assets }" id="family_assets" name = "family_assets" class="m-wrap span6" placeholder="家庭净资产" disabled="disabled">
														</div>
													</div>
													<!--/span-->
												</div>
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<select id="education" name="education" disabled="disabled">
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<select id="identity_type" name="identity_type" disabled="disabled">
												...
												<div class="row-fluid">
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<select id="live_require" name="live_require" disabled="disabled">
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<select id="age" name="age" disabled="disabled">
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<select id="manage_exp" name="manage_exp" disabled="disabled">
								...
								<div class="tab-pane active" id="tab_4">
									<c:forEach items="${signedList}" var="signed">
											
									<!-- BEGIN EXAMPLE TABLE PORTLET-->
									<div class="portlet box green">
										<div class="portlet-title">
											<div class="caption"><i class="icon-globe"></i>[${signed.countryZN }] ${signed.project_name }</div>
											
											<div class="tools">
												<a href="" class="btn blue addnew"><i class=" icon-plus"></i> 新增</a>
												<a href="/cust/signrecord/edit/${signed.signed_id }" class="btn yellow"><i class=" icon-edit"></i> 编辑</a>
												<a href="javascript:;" class="collapse"></a>
											</div>
										</div>
										<div class="portlet-body form">
											...
											<div class="row-fluid">
												<div class="span6 ">
													<div class="control-group">
														<label class="control-label">签约顾问：</label>
														${signed.adviser }
													</div>
												</div>
												<!--/span-->
											...
											<div class="row-fluid">
												...
												<div class="span6 ">
													<div class="control-group">
														<label class="control-label">办理进度：</label>
														${signed.other_applicant }
													</div>
												</div>
												<!--/span-->
				...
				.ready(
						function() {
							...
							$("#editBtn").click(function(e) {
								var id = "${cust.custinfoId}";
								location.href="/cust/edit/"+id;
							});
							
							//分配
							$("#assignBtn").click(function(e) {
								var ids = "${cust.custinfoId}";
								if (ids != "") {
							...
							$("#recordBtn").click(function(e) {
								var id = "${cust.custinfoId}";
								location.href="/cust/clue/editHis/"+id;
							});
		});
