						...
						<div class="portlet box grey">
							<div class="portlet-title" >
								...
								<div class="actions" align="left">
									...
									<button class="btn red" id="deleteBtn"> <i class="icon-remove-sign"></i>删除</button>
							...
							<div class="portlet-body  no-more-tables">
								<form id="searchForm" method="get">
									<table>
										<tr>
											<td width="120">姓名：</td>
											<td width="250"><input type="text" id="name" name="name" value="${name }"></td>
											<!-- <td width="100">手机号：</td>
											<td width="250" ><input type="text" id="phoneNum" name="phoneNum" value="${phoneNum }"></td> -->
											<td >
									...
									<div class="tabbable  boxless">
										<ul class="nav nav-tabs">
											<li class="active"><a href="#" data-toggle="tab" onclick="fastOper('')">全部(${all })</a></li>
											<li class="active"><a class="" href="#" data-toggle="tab" onclick="fastOper('assigned')">已分配(${assigned })</a></li>
											<li class="active"><a class="" href="#" data-toggle="tab" onclick="fastOper('noAssigned')">未分配(${noAssigned })</a></li>
											<li class="active"><a class="" href="#" data-toggle="tab" onclick="fastOper('changed')">已转换(${changed })</a></li>
											<li class="active"><a class="" href="#" data-toggle="tab" onclick="fastOper('invalid')">无效(${invalid })</a></li>
										</ul>
									</div>
									<table class="table table-bordered table-hover">
										...
										<thead>
											<tr>
												<th width="60" id="all"><input type="checkbox" /><span>全选</span></th>
												<c:choose>
												...
												<c:choose>
													<c:when test="${field=='cust.area' && way=='asc'}">
														<th width="60" class="sorting_asc"
															style="text-align: center" data-field="cust.area">所在地区</th>
													</c:when>
													<c:when test="${field=='cust.area' && way=='desc'}">
														<th width="60" class="sorting_desc"
															style="text-align: center" data-field="cust.area">所在地区</th>
													</c:when>
													<c:otherwise>
														<th width="60" class="sorting" style="text-align: center"
												...
												<th width="60"  style="text-align: center" data-field="cust.area">负责顾问</th>
										...
										<tbody id="list">
											<c:forEach items="${list}" var="item">
													...
													<c:if test="${item.color != null && item.color != '' }">
														<tr style="height:40px;" bgcolor="${item.color }">
													</c:if>
													<c:if test="${item.color == null || item.color == '' }">
													...
													<td data-title="客户名称"><a id="sd" href="/cust/clue/detail/${item.custinfo_id}">${item.name}</a>
													</td>
													<td data-title="手机号" style="display:none;">${item.phone_num}</td>
