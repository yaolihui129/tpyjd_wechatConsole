                    ...
                    <div class="span12">
                        ...
                        <div class="tabbable tabbable-custom">	
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="javascript:;">在线用户</a></li>
                                <li><a href="/live/list/room/application/${liveId }">临时申请</a></li>
                                <li><a href="/live/list/room/message/${liveId }">留言板</a></li>
                            </ul>
										...
										<tbody id="list">
											<c:forEach items="${list}" var="item" varStatus = "status">
												<tr style="height:40px;">
													...
													<td data-title="登录时间">
														<fmt:formatDate value="${item.online_time }" pattern="yyyy年MM月dd日 HH:mm:ss"/>
													</td>
													<td data-title="在线时间">
														${item.timeOnline }
													</td>
													<td>
														<div data-id="${item.application_id}">
															<a class="btn red-stripe mini"><i class="icon-remove">取消参与资格</i></a>
														</div>
													</td>
												</tr>
											</c:forEach>
								...
								$(this)
										.click(
												function(e) {
													...
													if(confirm("确定取消该用户的参与资格吗?")){
														$.post(
																"/live/list/room/cancelParticipation/"+id,
																{
																	"id" : id
																},
																function(data) {
