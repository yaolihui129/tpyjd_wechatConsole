                    ...
                    <div class="span12">
                        ...
                        <div class="tabbable tabbable-custom">	
                            <ul class="nav nav-tabs">
                                ...
                                <li class="active"><a href="javascript:;">临时申请</a></li>
										...
										<tbody id="list">
											<c:forEach items="${list}" var="item" varStatus = "status">
												<tr style="height:40px;">
													...
													<td data-title="邀请码">
														<c:if test="${empty item.invitation_code}">
															未生成
														</c:if>
														<c:if test="${not empty item.invitation_code}">
															${item.invitation_code}
														</c:if>
													</td>
													<td>
														<div data-id="${item.application_id}">
															<a class="btn blue-stripe mini"><i class="icon-envelope">短信发码</i></a>
														</div>
													</td>
												</tr>
											</c:forEach>
								...
								$(this)
										.click(
												function(e) {
													...
													if(confirm("是否发送短信?")){
														$.post(
																"/live/list/room/sendInvitationCode/"+id,
																function(data) {
																	if (data.status == 0) {
																		alert("听课码已发送");
																		location.reload();
