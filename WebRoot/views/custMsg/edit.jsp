                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form id="sform" class="form-horizontal"  method="post">
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls" style="font-size: 14px;font-weight: normal;line-height: 25px;padding-top: 5px;color: #595959;">${custinfoMessage.name}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls" style="font-size: 14px;font-weight: normal;line-height: 25px;padding-top: 5px;color: #595959;">${custinfoMessage.phone}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls" style="font-size: 14px;font-weight: normal;line-height: 25px;padding-top: 5px;color: #595959;">${custinfoMessage.content}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        <label class="control-label">来源专题：</label>
                                                        <div class="controls" style="font-size: 14px;font-weight: normal;line-height: 25px;padding-top: 5px;color: #595959;">
                                                        	<c:choose>
																<c:when test="${custinfoMessage.url != null and !empty custinfoMessage.url}"><a href="${OFFICIAL_URL}${custinfoMessage.url}" target="_blank">${custinfoMessage.source}</a></c:when>
																<c:otherwise>${custinfoMessage.source}</c:otherwise>
															</c:choose>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls" style="font-size: 14px;font-weight: normal;line-height: 25px;padding-top: 5px;color: #595959;"><fmt:formatDate value="${custinfoMessage.createTime}" type="both"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 ">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls" ><textarea data-length="150" data-label="备注" class="span10 m-wrap" rows="6" name="remark">${custinfoMessage.remark}</textarea></div>
                                                    </div>
                                                </div>
                                            </div>
