							...
							<div class="form-horizontal form-view">
								...
								<div class="tabbable tabbable-custom bodr-bm1 clear" style="margin-top:30px;">
									<ul class="nav nav-tabs">
										<li class="active"><a href="#tab_1_1" data-toggle="tab">发展客户</a></li>
									</ul>
									...
									<div class="span12" style="padding:20px 0px;">
										<div class="span4">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" placeholder="开始时间" class="m-wrap small" name="start_bind_proxy_time" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" value="${start_bind_proxy_time}"/>
													 -- 
													 <input type="text" placeholder="结束时间" class="m-wrap small" name="end_bind_proxy_time" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" value="${end_bind_proxy_time}"/>
												</div>
											</div>
										</div>
										<div class="span2">
