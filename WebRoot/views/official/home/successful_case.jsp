                                    ...
                                    <div class="portlet-body form">
                                         ...
                                         <form id="sform"  class="form-horizontal" method="post">
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <div class="control-group">
                                                         <label class="control-label">成功案例推荐首页：</label>
				                                         <div class="controls">
				                                         	<input type="text" id="successful_case_num" name="successful_case_num" must-be="true" data-label="推荐篇数" value="${successful_case_num}" placeholder="设置首页推荐的篇数" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/> 篇 
				                                         </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <div class="control-group">
                                                         <label class="control-label">成功案例轮播频率：</label>
				                                         <div class="controls">
				                                         	<input type="text" id="successful_case_rate" name="successful_case_rate" must-be="true" data-label="轮播频率" value="${successful_case_rate}" placeholder="设置轮播频率" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/> 秒 
				                                         </div>
                                                    </div>
                                                </div>
                                            </div>
