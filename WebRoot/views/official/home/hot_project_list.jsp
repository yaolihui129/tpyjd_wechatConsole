...
<body class="page-header-fixed">
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <c:if test="${fn:length(projectList) < 6}">
                        	<div class="portlet-title">
								<div class="actions">
									<a href="/official/home/addHotProject" class="btn blue addnew"><i class="icon-pencil"></i> 新增</a>
								</div>
							</div>
							</c:if>
                                         ...
                                         <form id="sform"  class="form-horizontal" method="post">
                                            <table class="table  table-bordered" id="para_table">
											    <tr>  
											        ...
											        <th style="text-align:center" width="200">项目名称</th>
											    ...
											    <c:forEach items="${ projectList }" var="project" varStatus="status">
												    <tr>  
												      ...
												      <div align="center">
															<c:if test="${not empty project.preferredPic}">
																<img src="${project.preferredPic}" style="width:60px;height:30px;">
															</c:if>
						...
						function(index, element) {
							$(this).click(function(e) {
												var id = $(
														...
														.parent()
														.attr("data-id");
												location.href = "/official/home/addHotProject?project_id="+ id;
											});
						});
      ...
      //绑定置顶按钮
		$("i.icon-upload").each(function(index, element) {
			$(this).click(function(e){
				...
				$.post("/official/home/projecttopsort",{"id":id},function(data){
					if(data.status==0){
	...
	//绑定上移按钮
		$("i.icon-long-arrow-up").each(function(index, element) {
			$(this).click(function(e){
				var id = $(this).parent().parent().attr("data-id");
				$.post("/official/home/projectupsort",{"id":id},function(data){
					if(data.status==0){
						window.location.reload();
						//doRequest();
					}
	...
	//绑定下移按钮
		$("i.icon-long-arrow-down").each(function(index, element) {
			$(this).click(function(e){
				var id = $(this).parent().parent().attr("data-id");
				$.post("/official/home/projectdownsort",{"id":id},function(data){
					if(data.status==0){
						window.location.reload();
						//doRequest();
					}
