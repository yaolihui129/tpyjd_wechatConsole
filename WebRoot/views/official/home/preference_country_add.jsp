                                                ...
                                                <div class="span12">
                                                    <div class="control-group">
				                                         ...
				                                         <div class="controls">
				                                         	...
				                                         	<c:forEach items="${countryList}" var="coun">
				                                         		<option value="${coun.id}">${coun.countryName}</option>
				                                         	</c:forEach>
				                                         	</select>
				                                         </div>
                                                    </div>
                                  ...
                                  <div class="control-group" style="border:none;">
									...
									<div class="controls">
										...
										<div style="float: left;   width:100px;height:100px;overflow:hidden;position:relative;">
											<c:if test="${!empty country.preferredPic}">
												<img  id="preferredPicImg" src="${country.preferredPic}" style="position:absolute;left:-1px;top:-1px;width:102px;height:102px;">
											</c:if>
											<c:if test="${empty country.preferredPic}">
											...
											<input type="hidden" id="preferred_pic" name="preferred_pic" data-label="优选国家图片(官网)"
											must-be="true" value="${country.preferredPic}" />
										 </div> 
										 </div>
									</div> 
									<div class="control-group" style="border:none;">
									...
									<label class="control-label"></label>
										<div class="controls">
                                            ...
                                            <span>支持jpg、png格式，尺寸760px*395px，大小在500K以内</span>
								 		</div>
									</div>
                                            <!--/row-->
                                            <c:if test="${not empty country.id}">
                                            	<input  id="old_country_id" name="old_country_id" type="hidden" value="${country.id}" />
                                            </c:if>
        ...
        jQuery(document).ready(function() {    
 		   ...
 		   App.init(); // initlayout and core plugin
 			...
 			$("#back").click(function(e) {
 				location.href="/official/home/preferenceCountryList";
             });
 			...
 			$("#subBtn").click(function(e) {
 				...
 				$.post(
						"/official/home/addPreferenceCountry",
						{
						...
						function(data) {
							if (data.code == 0) {
								alert("保存成功！");
								window.location.href="/official/home/preferenceCountryList"
							} else
								alert("保存失败！");
						});
             });
