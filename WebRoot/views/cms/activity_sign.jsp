				...
				<div class="row-fluid">
                    ...
                    <div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption"><i class="icon-list">&nbsp;<span style="font-size:18px;">当前活动：${activity_name}</span></i></div>
						</div>
                      ...
                      <form method="post" id="searchForm" method="get">
                       	<div class="row-fluid">
                              <div class="span6">     
                           	  ...
                           	  <div class="span6"><div id="sample_2_filter" class="dataTables_filter"><label><input id="name" class="m-wrap medium" placeholder="输入姓名或手机.." name="name" type="text"><a id="searchBtn" class="btn blue"><i class="icon-search"></i></a></label></div></div></div>
								  ...
								  <c:forEach items="${list}" var="item">
									<tr>
										...
										<td>
                                        	...
                                        	<td>
                                        		<fmt:formatDate value="${item.sign_time}" type="both"/>
                                        	</td>
								    </tr>
                                  </c:forEach>
							  </tbody>
