				...
				<div class="row-fluid">
					...
					<div class="span12"> 
						...
						<ul class="breadcrumb">
							...
							<li>
                                <a href="/steward/add/user">新增管家</a>
                            </li>
				...
				**/
				...
				$("#batchAdd").click(function(e) {
                   var checks = $("input.checkboxes:checked");
					if(checks.size()>0){
						...
						//dosomething
						$.post("/steward/list/add/tryAdd",{"ids":ids},function(data){
							if(data.status==0){
								alert("已成功添加到管家列表");
								checks.each(function(index, element) {
				...
				$("i.icon-save").each(function(index, element) {
					$(this).click(function(e){
						...
						$.post("/steward/list/add/tryAdd",{"ids":id},function(data){
							if(data.status==0){
								alert("已成功添加到管家列表");
