...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					...
					<div class="span12">  
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="/steward/list">管家管理<i class="icon-angle-right"></i></a>
                            </li>
                    ...
                    <div class="portlet-body form">
						<!-- BEGIN FORM-->
								...
								<form id="sform" method="post">
												...
												<div class="control-group">  
													<div class="controls">
													<span class="m-wrap span2" style="margin-top: 10px;">性别：</span>   
                                                    	<span class="m-wrap span2" style="margin-top: 10px;">${gender}</span>
													</div> 
												</div>
												<div class="control-group">
													<div class="controls"> 
                                                			<span class="m-wrap span2" style="margin-top: 10px;">手机号：</span> 
														<span class="m-wrap span2" style="margin-top: 10px;">${User.phone}</span>
													</div> 
												</div>
												<div class="control-group"> 
													<div class="controls"> 
														<span class="m-wrap span2" style="margin-top: 10px;">所在地区：</span> 
														<span class="m-wrap span2" style="margin-top: 10px;">${province}-${city} </span>
													</div> 
												</div>
												 <div class="control-group">
                                                    <label class="control-label" style="text-align: left;"><font color="#FF0000" style="margin-left:5px">*</font>照片：</label>
                                                    <div class="controls">
												...
												<div class="control-group">
													<label class="control-label"></label>
												 	<div style="margin-left: 100px;">
                                                        ...
                                                        <span> 支持jpg,png格式图片，大小不超过50kb</span>
												 	</div>
			                 
												</div>
												
												<div class="control-group">
                                                    <label class="control-label" style="text-align: left;">微信二维码：</label>
                                                    <div class="controls">
                                                    		
															<div style="float: left;   width:156px;height:156px;overflow:hidden;position:relative;">
                                                                <c:if test="${!empty User.wechat}">
                                                                    <img  id="showImg" src="${User.wechat}" style="position:absolute;left:-1px;top:-1px;width:156px;height:156px;">
                                                                </c:if>
                                                                <c:if test="${empty User.wechat}">
                                                                    <img  id="showImg" style="position:absolute;   top:-1px;  right: -1px; left:-1px; bottom:1px; width:156px;height:156px;" src="/images/nopic.jpg">
                                                                </c:if>
                                                                <input id="wechatPic" multiple accept="image/*" type="file">
                                                                <input data-label="微信二维码" type="hidden" id="wechat" name="wechat" value="${User.wechat}" />
														 	</div> 
												...
												<div class="control-group">
													<label class="control-label"></label>
												 	<div style="margin-left: 100px;">
												 		<span class="label label-important">图片格式</span>
                                                        <span> 支持jpg,png格式图片，建议尺寸大小不超过50kb</span>
												 	</div>
												</div>
												...
												<div class="control-group"> 
												 ...
												 <div class="control-group">
													<div class="controls"> 
												 		<span class="m-wrap span2" style="margin-top: 10px;">qq：</span> 
														<input placeholder="输入项是数字，最多可输入20个字符。" maxlength="20" class="m-wrap span6" type="text" data-label="qq" data-type="qq" data-length="20" name="qq" id="qq" value="${User.qq}">
													</div> 
												</div>
												
												<div class="control-group"> 
													<div class="controls"> 
                                                		<span class="m-wrap span2" style="margin-top: 10px;">电子邮箱：</span> 
														<input placeholder="请输入11位的数字合法邮箱，最多可输入40个字符。" maxlength="40" class="m-wrap span6" type="text" data-label="电子邮箱" data-length="40" data-type="email" name="email" id="email" value="${User.email}">
                                               	...
                                               	<div class="control-group"> 
													<div class="controls">
														<span class="m-wrap span2" style="margin-top: 10px;"><font color="#FF0000" style="margin-left:5px">*</font>个人简介：</span>  																												<%-- ${stewardUser.introduce} ${!empty stewardUser.provinceId}	${ provinces} --%>
														<textarea placeholder="一段文字介绍顾问，最多可输入100个汉字。"  maxlength="100" rows="7" class="m-wrap span6" must-be="true" data-label="个人简介" data-length="100" name="introduce" id="introduce">${User.introduce}</textarea>
													</div> 
												</div>
												
												<div class="control-group"> 
													<div class="controls">
														<span class="m-wrap span2" style="margin-top: 10px;">启用名片：</span>  		
														<label class="radio">
															<input type="radio" name="card_status" value="0" <c:if test="${stewardUser.cardStatus == 0}">checked="checked" </c:if>/> 否
														</label>
														<label class="radio">
															<input type="radio" name="card_status" value="1" <c:if test="${stewardUser.cardStatus == 1}">checked="checked" </c:if>/> 是
														</label>
													</div> 
												</div>
												...
												<c:if test="${stewardUser.releaseMark!='已下线'}">
	...
	<script> 
		...
		///图片上传
		$('#wechatPic').change(function() {
		var files = $('#wechatPic').prop('files');
		//$('#showImg').attr("src","/images/loading.gif");
		var imgUrl = $("#wechat").val();
