                    ...
                    <div class="portlet-body">
                    	 <div class="tabbable tabbable-custom tabbable-full-width">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="/steward/list/detail/sign/${stewardId}">聘用纪录</a></li>
							...
							<div class="tab-content">
								<div class="tab-pane active">
                                	<div class="row-fluid">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" height="50" style="font-size:14px;">
                                      <tr>
                                        <td>管家姓名：${stewardName}</td>
                                        <td>英文名：${englishName}</td>
                                        <td>当前聘请次数：${signed-unsigned}</td>
                                        <td>共计被聘请次数：${signed}</td>
                                        <td>解聘：${unsigned}</td>
                                      </tr>
                                    </table>
                                    </div>
