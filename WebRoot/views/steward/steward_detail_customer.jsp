                    ...
                    <div class="portlet-body">
                    	 <div class="tabbable tabbable-custom tabbable-full-width">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="/steward/list/detail/customer/${stewardId}">服务用户</a></li>
                                     ...
                                     <div class="span12">
                                                <div class="span4 ">
                                                    <div class="control-group">
                                                        <label class="control-label" style="float:left; line-height: 30px; margin-right:10px;">用户昵称:</label>
                                                        <div class="controls">
                                                            <input id="nick_name" class="m-wrap meduam" placeholder="输入用户昵称" name="nick_name" type="text" value="${nick_name}">
                                                        </div>
                                                    </div>
                                                </div>
                                      ...
                                      <table class="table">
                                          <thead>
                                              <tr>
                                                 ...
                                                 <th>来源</th>
                                                 <c:choose>
                                                      <c:when test="${field=='passed_time' && way=='asc'}">
                                                          <th class="sorting_asc" data-field="passed_time">时间</th>
                                                      </c:when>
                                                      <c:when test="${field=='passed_time' && way=='desc'}">
                                                          <th  class="sorting_desc" data-field="passed_time">时间</th>
                                                      </c:when>
                                                      <c:otherwise>
                                                         <th class="sorting" data-field="passed_time">时间</th>
                                                      </c:otherwise>
                                                  </c:choose>
                                              </tr>
                                          ...
                                          <tbody id="list">
                                              <c:forEach items="${list}" var="item">
                                                <tr>
                                                    <td><c:choose>
                                             	<c:when test="${empty item.wxName}">
                                             		未设置
                                             	</c:when>
                                             	<c:otherwise>
                                             		<script type="text/javascript">document.write(decodeURI("${item.wxName }"));</script>
                                             	</c:otherwise>
                                             </c:choose>
                                             </td>
                                                    <td>${item.phoneNum}</td>
                                                    ...
                                                    <td><fmt:formatDate value="${item.passedTime}" type="both"/></td>
                                                </tr>
                                              </c:forEach>
                                          </tbody>
