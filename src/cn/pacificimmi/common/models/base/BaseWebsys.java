...
public abstract class BaseWebsys<M extends BaseWebsys<M>> extends Model<M> implements IBean {
	...
	public void setOathurl(java.lang.String oathurl) {
		set("oathurl", oathurl);
	}

	public java.lang.String getOathurl() {
		return get("oathurl");
	}
