...
public abstract class BaseInformationArticle<M extends BaseInformationArticle<M>> extends Model<M> implements IBean {
	...
	public void setPushLocation(java.lang.String pushLocation) {
		set("push_location", pushLocation);
	}

	public java.lang.String getPushLocation() {
		return get("push_location");
	}
